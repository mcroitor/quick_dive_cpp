...
Переменные, объявленные в классе, называются __члена-данными__ (или __свойствами__, а также __полями__), функции, объявленные в классе, называются __член-функциями__ (или __методами__). В классе можно управлять доступом к объявленным переменным и функциям, делая их доступными для пользователя или скрывая их.
