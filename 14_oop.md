...
Объектно-ориентированное программирование (ООП) есть парадигма программирования, основанная на использовании объектов и классов. В данной парадигме всё является объектом или его частью, и в рамках ООП программа рассматривается как взаимодействие объектов.

Основные принципы ООП – _инкапсуляция_, _наследование_ и _полиморфизм_.
