...
Существует также версия Visual Studio Community Edition, которая предоставляется бесплатно для некоммерческого использования. В этом случае необходимо зарегистрироваться на сайте компании Microsoft и получить лицензию на использование Visual Studio Community Edition. Данная версия позволяет вести полноценную разработку, но ограничена в проектировании и анализе кода.
