...
- [Развитие языка С++: стандарты, компиляторы, среда разработки](#развитие-языка-с-стандарты-компиляторы-среда-разработки)
  ...
  - [Компиляторы](#компиляторы)
    ...
    - [clang](#clang)
    - [llvm](#llvm)
  - [Интегрированные среды разработки](#интегрированные-среды-разработки)
...
8. сделать C++ проще для изучения без удаления возможностей, используемых программистами-экспертами.
...
- __c++20__
  ...
  - модули
  - сопрограммы
  - введён оператор трехстороннего сравнения (_звездолёт_)
  - концепции
...
- __c++23 [^3]__
  - исправление ошибок стандарта _с++20_
...
[Visual Studio](https://visualstudio.microsoft.com) - среда разработки от Microsoft, предназначенная для создания программного обеспечения на различных языках программирования, включая С++. Visual Studio является мощным инструментом, покрывающим все этапы разработки программного обеспечения, включая проектирование, разработку, тестирование и отладку, в связи с чем является частым решением для разработки крупных проектов. Основным компилятором, используемым в Visual Studio, является MSVC. Visual Studio является средой разработки в основном для операционной системы Windows, однако также существует версия для macOS.

Существует также версия Visual Studio Community Edition, которая предоставляется бесплатно для некоммерческого использования. В этом случае необходимо зарегистрироваться на сайте компании Microsoft для активации через аккаунт Microsoft. Данная версия позволяет вести полноценную разработку, но ограничена в комерчесском использовании.

### CLion

![CLion](./images/11_7_clion.png)

[CLion](https://www.jetbrains.com/clion) - среда разработки от компании JetBrains, предназначенная для создания программного обеспечения на С++. CLion является мощным инструментом, покрывающим все этапы разработки программного обеспечения, включая проектирование, разработку, тестирование и отладку. В связи с этим CLion является частым решением для разработки крупных проектов. CLion использует компиляторы GCC, MSVC, Clang и другие (однако сама среда разработки поставляется без компилятора). Основным инструментом сборки является CMake. CLion является кроссплатформенной средой разработки, что позволяет использовать её на различных операционных системах, включая Windows, Linux и macOS.

Существует образовательная лицензия для студентов и преподавателей, позволяющая использовать CLion бесплатно. В этом случае необходимо запросить лицензию на сайте компании JetBrains, на базе почты учебного заведения.

## Библиография

[^1]: [Страуструп Бьёрн, Дизайн и философия С++](https://www.google.com/search?q=Страуструп+Бьёрн%2C+Дизайн+и+философия+С%2B%2B)
