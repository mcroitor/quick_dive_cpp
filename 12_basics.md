...
Константами являются неизменяемые величины и могут быть представлены числом (целым или действительным), сиволом или последовательностью символов (строкой).
...
В версии С89 определено 32 ключевых слова.
 ...
 - __auto__ — Спецификатор типа для указания компилятору локальной области видимости переменной (по умолчанию)
...
В языке C++ содержатся все ключевые слова, определенные в версии _С89_, а также следующие:
...
> Термин аргумент относится к значению, которое используется при вызове функции. Переменная, которая принимает этот аргумент, называется параметром. Функции, которые принимают аргументы, называются параметризованными функциями. [Шилдт]
