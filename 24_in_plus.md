...
Использование адаптеров интервалов основано на идеях функционального программирования, которые позволяют выполнять конвейерную обработке данных. Для реализации конвейерной обработки данных используется переопределение оператора `|` для передачи данных между адаптерами.
...
- `views::for_each` - применение функции к каждому элементу
